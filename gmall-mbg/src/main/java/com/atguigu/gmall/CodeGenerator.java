...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\workspace\\gmallparent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("JRJ");
        ...
        dsc.setUrl("jdbc:mysql://172.17.128.130:3306/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
